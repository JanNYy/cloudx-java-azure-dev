...
//        Comment of all the lines for the task Introduce an error in com.chtrembl.petstoreapp.service.ProductManagementService#getProductsByCategory() by adding the line:
...
//
//            this.sessionUser.getTelemetryClient().trackMetric("ProductsReturnedCount", products.size());
//
//            return products;
